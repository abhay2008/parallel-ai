...
if not LOG_FILE.exists() and (Path(__file__).resolve().parent.parent / "marathon_results.log").exists():
    LOG_FILE = Path(__file__).resolve().parent.parent / "marathon_results.log"

ROUTER_SCRIPT = Path(__file__).resolve().parent / "parallel_router.py"
if not ROUTER_SCRIPT.exists() and (Path(__file__).resolve().parent.parent / "parallel_router.py").exists():
    ROUTER_SCRIPT = Path(__file__).resolve().parent.parent / "parallel_router.py"
